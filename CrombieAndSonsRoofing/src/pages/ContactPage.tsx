...
export default function ContactPage() {
  ...
  return (
    <>
      <SEO title="Contact Crombie & Sons Roofing | Get a Free Estimate" description="Contact Crombie & Sons Roofing in Red Deer for a free estimate on roof repair, replacement, or exterior services. Fill out our form or call us today!" />  
