...
export default function ServicesPage() {
  return (
    <>
      <SEO title="Roof Repair & Replacement in Red Deer | Roofing Services" description="Professional roof repair, replacement, and exterior services in Red Deer, Alberta. From small leaks to full roofing systems, we deliver durable, reliable results." />
